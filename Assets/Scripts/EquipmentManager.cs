...
public class EquipmentManager : MonoBehaviour{
    ...
    SkinnedMeshRenderer [] currentMeshes;   //  Array to keep track of "skinned-mesh renders" 

    //  Callback for when an item is equipeed/unequipped
    ...
    public void Equip (Equipment newItem){
        ...
        Equipment oldItem = Unequip(slotIndex); //  Does lines 49-54 essentially


        //  If there was already an item in the slot (LINE 45 Overrides this IF)
    ...
    // Unequip all items with a particular index
    public Equipment Unequip (int slotIndex){
        ...
        if (currentEquipment[slotIndex] !=null){
            ...
            //  Remove the item from then equipment array
